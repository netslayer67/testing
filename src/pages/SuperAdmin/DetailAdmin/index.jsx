...
import { getDetailSuperAdminFap } from "../../../redux/reducers/superAdminReducer";

const DetailFapSuperAdmin = () => {
  ...
  useEffect(() => {
    if (fetching) {
      dispatch(getDetailSuperAdminFap(id));
...
export default DetailFapSuperAdmin;
